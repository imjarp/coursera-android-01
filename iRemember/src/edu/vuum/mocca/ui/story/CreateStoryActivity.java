...
public class CreateStoryActivity extends StoryActivityBase {
	...
	private void launchCameraIntent() {
		...
		//Intent mImageIntent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE,getOutputMediaFileUri(MEDIA_TYPE_IMAGE));
		...
		File mImageFile = getOutputMediaFile(MEDIA_TYPE_IMAGE);
		fragment.imagePath= Uri.parse(mImageFile.getAbsolutePath());
		
		// TODO - Add the filename to the Intent as an extra. Use the Intent-extra name
		// from the MediaStore class, EXTRA_OUTPUT
		mImageIntent.putExtra(MediaStore.EXTRA_OUTPUT, getOutputMediaFileUri(MEDIA_TYPE_IMAGE));
		
		// TODO - Start a new activity for result, using the new intent and the request
		// code CAMERA_PIC_REQUEST
		startActivityForResult(mImageIntent, CAMERA_PIC_REQUEST);
	...
	private void launchVideoCameraIntent() {
		...
		// TODO - Add the filename to the Intent as an extra. Use the Intent-extra name
		// from the MediaStore class, EXTRA_OUTPUT
		mVideoIntent.putExtra(MediaStore.EXTRA_OUTPUT, mVideoFile.getAbsolutePath());
		...
		startActivityForResult(mVideoIntent, CAMERA_VIDEO_REQUEST);
